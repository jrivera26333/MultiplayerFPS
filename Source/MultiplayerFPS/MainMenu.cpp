...
bool UMainMenu::Initialize()
{
	...
	if (!ensure(CancelSettingsButton != nullptr)) return false;
	CancelSettingsButton->OnClicked.AddDynamic(this, &UMainMenu::OpenMainMenu);
...
void UMainMenu::SetServerList(TArray<FServerData> ServerNames)
{
	...
	{
		UHostInfoRow* Row = CreateWidget<UHostInfoRow>(World, ServerRowClass);
...
void UMainMenu::UpdateChildren()
{
	...
	{
		auto Row = Cast<UHostInfoRow>(ServerList->GetChildAt(i));
		if (Row != nullptr)
		{
